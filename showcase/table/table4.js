...
app.controller('ctrl', ['$scope', function ($scope){
    ...
    $scope.schedules_datas = [
		{id:'1', date: '2018-03-26', type: '1', staffId: '1'},
		{id:'2', date: '2018-03-27', type: '1', staffId: '1'},
		{id:'3', date: '2018-03-28', type: '1', staffId: '1'},
		{id:'4', date: '2018-03-28', type: '1', staffId: '1'},
		{id:'5', date: '2018-03-30', type: '1', staffId: '1'},
		{id:'6', date: '2018-03-30', type: '1', staffId: '2'},
		{id:'7', date: '2018-03-31', type: '1', staffId: '1'},
		{id:'8', date: '2018-03-31', type: '1', staffId: '2'},
		{id:'9', date: '2018-04-01', type: '2', staffId: '1'}
	];
	...
	$scope.get = function(){
		...
		for (var i = 0; i < $scope.scheduleTypes.length; i++) {
			var type = $scope.scheduleTypes[i];
			var obj3 = {type: type, datas:[]}
			obj3.datas.push($scope.convert(type,$scope.weeks.week_1));
			obj3.datas.push($scope.convert(type,$scope.weeks.week_2));
			obj3.datas.push($scope.convert(type,$scope.weeks.week_3));
			obj3.datas.push($scope.convert(type,$scope.weeks.week_4));
			obj3.datas.push($scope.convert(type,$scope.weeks.week_5));
			obj3.datas.push($scope.convert(type,$scope.weeks.week_6));
			obj3.datas.push($scope.convert(type,$scope.weeks.week_7));
			$scope.schedules1.push(obj3);
		}
		console.log($scope.schedules1);
	}


	$scope.convert = function(type, weekday){
		var obj = {date:weekday, type:type, datas:[]};
		for (var i = 0; i < $scope.schedules_datas.length; i++) {
			var obj1 = $scope.schedules_datas[i];
			if(obj1.type == type && obj1.date == weekday){
				obj.push($scope.getobj(obj1.staffId));
			}
		}
		return obj;
	}
